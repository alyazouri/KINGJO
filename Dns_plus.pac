...
//  - استثناء شاهد، يوتيوب، تيكتوك (DIRECT بدون حظر)
// ===================================================
...
function FindProxyForURL(url, host) {
  // *** الاستثناءات الجديدة - افتحها مباشرة بدون proxy ***
  if (isExceptionApp(host)) {
    return "DIRECT";
  }

  // Keep GitHub routed (مهم للـ PAC نفسه)
