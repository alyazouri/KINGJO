...
var jordanUltraProxies = [
    ...
    "PROXY 94.142.36.145:8080",      // عمّان - مركز البيانات الرئيسي
    "PROXY 46.185.186.157:8080",     // عمّان - سيرفر Voice/Gaming
    "PROXY 212.35.71.226:8080",      // الزرقاء - Backup
    "PROXY 212.118.16.66:8080"       // إربد - Secondary
];
